...
abstract class ObjectBase
{
    ...
    public function __construct(\SimpleXMLElement $xml = null)
    {
        ...
        if (count($xml->relatedObjects)) {
            if (empty($xml->relatedObjects)) {
                ...
                $this->relatedObjects = \Kaltura\Client\ParseUtils::unmarshalMap(
                    $xml->relatedObjects,
                    "KalturaListResponse"
                );
            }
    ...
    protected function addIfNotNull(array &$params, string $paramName, $paramValue): void
    {
        if ($paramValue !== null) {
            if ($paramValue instanceof self) {
